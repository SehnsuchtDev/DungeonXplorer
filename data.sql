...
insert into Loot values(1,2,NULL,0,1);
insert into Loot values(2,6,NULL,0,1);
insert into Loot values(2,14,NULL,0,1);
insert into Loot values(3,4,NULL,0,1);
insert into Loot values(4,7,'MANA',10,1);
insert into Loot values(5,8,'STRENGTH',5,2);
insert into Loot values(5,9,'INITIATIVE',5,2);
insert into Loot values(6,10,'MANA',5,2);
insert into Loot values(6,11,'LIFE',5,2);
insert into MCQTest values(1,'Quel est le nom du gros cochon?');
insert into MCQTest values(5,'Quel est la taille du grand Milan?');
insert into MCQAnswer values(1,'Dylan');
insert into MCQAnswer values(1,'Lomepal');
insert into MCQAnswer values(1,'Mylan');
insert into MCQAnswer values(1,'Le gros Leopold');
insert into MCQAnswer values(5,'1,75m');
insert into MCQAnswer values(5,'1,70m');
insert into MCQAnswer values(5,'3,20m');
insert into MCQAnswer values(5,'2^1024m');
