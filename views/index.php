...
<body class="bg-[#1a1a1a]">
    ...
    <main class="z-20 relative">
        ...
        <div
            class="bg-[rgba(46,46,46,0.80)] place-self-center max-w-[50em] rounded text-[#e5e5e5] font-['Roboto'] p-12 m-24 text-center text-xl">
            <p>
    ...
    <img src="..\public\assets\dungeon.png" alt="Dungeon" title="Dungeon"
        class="z-0 max-w-[50%] absolute left-0 mt-20" />
