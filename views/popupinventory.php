...
<body>
    <div class="bg-[#000000d4] h-screen w-screen text-[#ADADAD]">
        <div class="bg-[#2E2E2E] inset-0 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 size-max w-11/12 max-w-3xl p-4 rounded shadow-lg ">
                    ...
                    <tr>
                        ...
                        <?php for($i = 0; $i < 8; $i++):?>
                            ...
                            <th value="<?=$items[$i]['id']?>"
                                ...
                                <img src="<?=FULLURLROOTPATH?>/public/assets/<?=$items[$i]['image']?>" class="object-cover w-full h-full rounded">
                                <?php if ($items[$i]['quantity'] > 1) :?>
                                    <div class="absolute z-20 left-0 top-0 ml-2 text-[#C4975E]">x<?=$items[$i]['quantity']?></div>
                                <?php endif ?>
                            </th>
                            <?php else :?>
