<div id="divConnection"
    ...
    <form id="formulaire-connexion<?= $seed ?>" method="post" action="<?= FULLURLROOTPATH ?>/book/page/login">
        ...
        <span class="flex flex-col items-center space-y-3 mt-10">
            <input type="submit" value="Se connecter" class="text-[2vh] bg-[#2E2E2E] py-4 px-7 rounded pointer-events-auto cursor-pointer
                    max-[640px]:w-32
                    max-[640px]:p-3
                    max-[500px]:p-2" />
            ou
