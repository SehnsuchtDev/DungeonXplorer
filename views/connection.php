<div class="bookcover bg-contain bg-no-repeat text-[#FFFFFF] place-self-center font-['Pirata_One'] w-full h-full">
    ...
    <span class="flex flex-col items-center space-y-4 mt-16">
        <button id="connect" type="button" class=" bg-[#2E2E2E] p-4 w-48  rounded pointer-events-auto"> Se connecter
        </button>
