<div
    id="divConnection" class="pagediv ml-[-200px] bookcover bg-contain bg-no-repeat text-[#FFFFFF] place-self-center font-['Pirata_One'] w-full h-full">
    ...
    <span class="flex flex-col items-center space-y-4 mt-16">
        <input type="submit" value="Se connecter" class=" bg-[#2E2E2E] p-4 w-48 rounded pointer-events-auto"/>
