                ...
                <tr class="border border-[#C4975E]">
                    <form action="<?= FULLURLROOTPATH ?>/admin/item/modify/<?= $item["it_id"] ?>" method="post">
                        <td class="p-10">
                            <div class="flex">
                                <p>Nom : &nbsp;</p>
                                <input name="name" type="text" value="<?= $item["it_name"] ?>"
                                    class="max-h-6 rounded bg-[#3a3a3a]">
                            </div>
                            <div class="flex">
                                <p>Description : &nbsp;</p>
                                <input name="desc" type="text" value="<?= $item["it_description"] ?>"
                                    class="max-h-6 rounded bg-[#3a3a3a]">
                            </div>
                            <div class="flex">
                                <p>Poids : &nbsp;</p>
                                <input name="poids" type="number" value="<?= $item["it_weight"] ?>"
                                    class="max-h-6 rounded bg-[#3a3a3a]">
                            </div>
                            <div class="flex">
                                <p>Nombre max : &nbsp;</p>
                                <input name="nbMax" type="number" value="<?= $item["it_maxstack"] ?>"
                                    class="max-h-6 rounded bg-[#3a3a3a]">
                            </div>
                            <div class="flex">
                                <p>Equipable : &nbsp;</p>
                            ...
                            <div class="flex">
                                <p>Nom de l'effet : &nbsp;</p>
                                <input name="nomEffet" type="text" value="<?= $item["it_effectname"] ?>"
                                    class="max-h-6 rounded bg-[#3a3a3a]">
                            </div>
                            <div class="flex">
                                <p>Valeur de l'effet : &nbsp;</p>
                                <input name="valEffet" type="number" value="<?= $item["it_effectvalue"] ?>"
                                    class="max-h-6 rounded bg-[#3a3a3a]">
                            </div>
                            <div class="flex">
                                <p>Coût en mana : &nbsp;</p>
                                <input name="coutMana" type="number" value="<?= $item["it_manacost"] ?>"
                                    class="max-h-6 rounded bg-[#3a3a3a]">
                            </div>
                            <div class="flex">
                                <p>Valeur de protection : &nbsp;</p>
                                <input name="valProtection" type="number" value="<?= $item["it_protectvalue"] ?>"
                                    class="max-h-6 rounded bg-[#3a3a3a]">
                            </div>
                            <div class="flex">
                                <p>Nombre de dégâts : &nbsp;</p>
                                <input name="nbDegat" type="number" value="<?= $item["it_damage"] ?>"
                                    class="max-h-6 rounded bg-[#3a3a3a]">
                            </div>
                            <div class="flex m-3">
                                <img src="<?= FULLURLROOTPATH ?>/public/assets/<?= $item["it_image"] ?>" alt="image"
                                    width="100" height="100" class="m-3" />
                        ...
                        <td class="p-7 text-right text-lg flex-col">
                            <div class="flex flex-col">
                                <input type="submit" value="Modifier"
                                    class="bg-[#C4975E] text-white w-36 h-10 rounded hover:bg-[#C49700] my-1.5">
                                <a href="<?= FULLURLROOTPATH ?>/admin/item/delete/<?= $item["it_id"] ?>"
                                    class="bg-[#C4975E] text-center content-center text-white w-36 h-10 rounded hover:bg-[#C49700] my-1.5">
                                    Supprimer</a>
                            </div>
                        </td>
                    </form>
        ...
        <form action="<?= FULLURLROOTPATH ?>/admin/item/add/" method="post">
            ...
            <div class="text-center">
                <input type="submit" value="Ajouter"
                    class="bg-[#C4975E] text-white w-36 h-10 rounded hover:bg-[#C49700] ml-2 mt-5">
            </div>
        </form>
    </div>
