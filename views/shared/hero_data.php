    ...
    <div class="w-[90%] ml-9 flex flex-col items-center justify-center font-['Pirata_One'] text-[#ADADAD] text-[5vh]">
        ...
        <div class="w-[800px] flex flex-row">
            ...
            <div class="flex flex-row justify-between w-[70%]">
                ...
                <div class="flex flex-row items-center">
                    <img src="<?= FULLURLROOTPATH ?>/public/assets/hero_data_icons/strength_icon.png"
                        alt="Icône énergie" width="40"
                        class="max-[790px]:max-w-10 max-[700px]:max-w-8 max-[580px]:max-w-6 max-[615px]:rotate-90">
            ...
            <div class="ml-10 w-[30%] flex flex-row-reverse justify-evenly
                ...
                <button id="inventory-button">
                    <img src="<?= FULLURLROOTPATH ?>/public/assets/hero_data_icons/inventory_icon.svg"
                        alt="Inventory icon" width="50" class=" max-[615px]:rotate-90">
                ...
                <div class="flex flex-row items-center">
                    <?php if (isset($primaryWeaponImage)): ?>
                        <img src="<?= FULLURLROOTPATH ?>/public/assets/<?= $primaryWeaponImage ?>" alt="Arme primaire"
                            ...
                            max-[615px]:rotate-90" id="primary-weapon" aria-details="<?= $primaryWeaponId ?>">
                    <?php endif; ?>
