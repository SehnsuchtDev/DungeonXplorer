...
<header class="bg-[#2e2e2e] flex flex-row justify-between">
    ...
    <div class="flex flex-row">
       <a href="<?= FULLURLROOTPATH ?>">
           <img src="<?= FULLURLROOTPATH ?>/public/assets/Logo.png" title="logoDungeonXplorer" class="size-28
    ...
    <div class="flex flex-row space-w">
        ...
        <?php if(isset($_SESSION["user"])) : ?>
            <a href="<?= FULLURLROOTPATH ?>/book" class="bg-[#C4975E] my-7 mx-6 place-content-center rounded-lg max-[615px]:invisible max-[615px]:absolute" >
