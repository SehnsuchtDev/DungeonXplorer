<?php
// Check the hero's class from the session and assign the corresponding class name
$class = "Unknown class";
...
<body>
    ...
    <ul>
        <li><img src="<?= htmlspecialchars($_SESSION['user']->getHero()->getImage()) ?>"
                alt="image correspondant au héro"></li>
